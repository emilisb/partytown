...
// import { WorkerProxy__OLD } from './worker-proxy-constructor__OLD';

// const taskQueue: MainAccessTask[] = [];

// const queue = (
//   instance: WorkerProxy__OLD,
//   $applyPath$: ApplyPath,
//   isSetter?: boolean,
...
// export const setter = (instance: WorkerProxy__OLD, applyPath: ApplyPath, value: any) => {
...
//       const workerProxy = new WorkerProxy__OLD(interfaceType, instanceId, winId);
